...
# Global assignments 
set_global_assignment -name TOP_LEVEL_ENTITY "|accumulate"
set_global_assignment -name ROUTING_BACK_ANNOTATION_MODE NORMAL
set_global_assignment -name FAMILY "CYCLONE V"
set_global_assignment -name DEVICE "5CSEBA6U23I7"
set_global_assignment -section_id accumulate -name EDA_DESIGN_ENTRY_SYNTHESIS_TOOL "SYNPLIFY"
...
set_global_assignment -name SDC_FILE "accumulate.scf"
