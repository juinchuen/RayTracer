...
vlog -work work "sub_tb.sv"

# run simulation
vsim -classdebug -voptargs=+acc +notimingchecks -L work work.tb -wlf sub.wlf
...
add wave -noupdate -group tb/u_sub
add wave -noupdate -group tb/u_sub -radix hexadecimal /tb/u_sub/*

add wave -noupdate -group tb/u_sub/u_sub_module
add wave -noupdate -group tb/u_sub/u_sub_module -radix hexadecimal /tb/u_sub/u_sub_module/*
